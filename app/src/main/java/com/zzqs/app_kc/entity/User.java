...
public class User implements Parcelable {
    ...
    public String toString() {
        return "User{" +
                ...
                ", localIdCardPhoto='" + localIdCardPhoto + '\'' +
                ", drivingIdPhoto='" + drivingIdPhoto + '\'' +
                ", localDrivingIdPhoto='" + localDrivingIdPhoto + '\'' +
                ", travelIdPhoto='" + travelIdPhoto + '\'' +
                ", localTravelIdPhoto='" + localTravelIdPhoto + '\'' +
                ", tradingIdPhoto='" + tradingIdPhoto + '\'' +
                ", localTradingIdPhoto='" + localTradingIdPhoto + '\'' +
                ", platePhotos='" + platePhotos + '\'' +
                ", localPlatePhotos='" + localPlatePhotos + '\'' +
