...
public class Tender implements Parcelable {
    ...
    private List<Double> pickup_region_location = new ArrayList<>();
    ...
    private List<Double> delivery_region_location = new ArrayList<>();
    ...
    public List<Double> getPickup_region_location() {
        return pickup_region_location;
    }

    public void setPickup_region_location(List<Double> pickup_region_location) {
        this.pickup_region_location = pickup_region_location;
    }

    public List<Double> getDelivery_region_location() {
        return delivery_region_location;
    }

    public void setDelivery_region_location(List<Double> delivery_region_location) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeList(this.pickup_region_location);
        ...
        dest.writeList(this.delivery_region_location);
    ...
    protected Tender(Parcel in) {
        ...
        this.pickup_region_location = new ArrayList<Double>();
        in.readList(this.pickup_region_location, Double.class.getClassLoader());
        ...
        this.delivery_region_location = new ArrayList<Double>();
        in.readList(this.delivery_region_location, Double.class.getClassLoader());
