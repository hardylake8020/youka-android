...
//                        TestinAgent.uploadException(paramContext, "username:" + username + ";versionCode:" + BuildConfig.VERSION_CODE, throwable);
                        ...
                        user.setTruck_type(object.optString("truck_type"));
                        user.setTruck_number(object.optString("truck_number"));
                        user.setTruck_photo(object.optString("truck_photo"));
                        user.setTruck_list_photo(object.optString("truck_list_photo"));
                        user.setBank_username(object.optString("bank_username"));
                        user.setBank_name(object.optString("bank_name"));
                        user.setBank_number_photo(object.optString("bank_number_photo"));
                        user.setBank_number(object.optString("bank_number"));
                        user.setId_card_number(object.optString("id_card_number"));
                        user.setCar_plate_photo(object.optString("plate_photo"));
    ...
    public static Order orderParse(Context context, JSONObject orderObject) {
        ...
        order.setSerialNo(orderObject.optString("order_number"));
        order.setRefNum(orderObject.optString("refer_order_number"));
        if (orderObject.has("goods")) {
            JSONArray goodsArray = orderObject.optJSONArray("goods");
            if (null != goodsArray) {
                /**
